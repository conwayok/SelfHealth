...
public class ExportImportActivity extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    private void importData(File file) {
        try {
            ...
            List<DailyDataModel> dailyDataModelList = mapper.readValue(file, typeFactory.constructCollectionType(List.class, DailyDataModel.class));
            Log.i(TAG, dailyDataModelList.size() + "");
            Toast.makeText(ExportImportActivity.this, "import " + dailyDataModelList.size() + " counts", Toast.LENGTH_SHORT).show();
