...
public class ChartActivity extends AppCompatActivity {
  ...
  @BindView(R.id.average_textView)
  TextView averageTextView;

  @BindView(R.id.goal_textView)
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    final HealthDataCalculator healthDataCalculator =
        new HealthDataCalculator(this, LocalDate.of(2018, 1, 1), LocalDate.now());
    ...
    lineChart
        .getXAxis()
        .setLabelCount(dailyDataModelList.size() > 9 ? 9 : dailyDataModelList.size());
    lineChart
        .getXAxis()
        .setValueFormatter(
            new IAxisValueFormatter() {
              ...
              public String getFormattedValue(float value, AxisBase axis) {
                ...
                if (index < 0 || index >= dailyDataModelList.size()) return "";
      ...
      case PHONE_USE:
        if (settings != null) {
          goalTextView.setText(
              getText(R.string.limit) + ": " + settings.getDailyPhoneUseHoursGoal());
        }
        averageTextView.setText(
            getString(R.string.average)
                + ": "
